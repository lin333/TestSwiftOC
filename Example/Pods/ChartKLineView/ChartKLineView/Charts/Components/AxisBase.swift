...
open class AxisBase: ComponentBase
{
    ...
    @objc open var axisLineColor = NSUIColor.clear
    ...
    @objc open var gridColor = NSUIColor.clear
    ...
    @objc open var _axisMinimum = Double(0)
    ...
    @objc open var _axisMaximum = Double(0)
