...
public protocol ChartViewDelegate
{
    ...
    @objc optional func chartViewBeginPanning(_ chartView: ChartViewBase)
...
open class ChartViewBase: NSUIView, ChartDataProvider, AnimatorDelegate
{
    ...
    @objc open var _legendRenderer: LegendRenderer!
    ...
    @objc open func calculateOffsets()
    {
    ...
    @objc open func drawDescription(context: CGContext)
    {
    ...
    @objc open func drawMarkers(context: CGContext)
    {
