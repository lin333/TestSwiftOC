...
#define SAFEAREA_STATUSBAR_HEIGHT                           (TBAvalibleOS(11) ? ([[UIApplication sharedApplication].keyWindow valueForKey:@"safeAreaInsets"] ? ((NSValue *)[[UIApplication sharedApplication].keyWindow valueForKey:@"safeAreaInsets"]).UIEdgeInsetsValue.top ?: 20 : 20) : 20)
